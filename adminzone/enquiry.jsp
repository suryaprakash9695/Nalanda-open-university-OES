...
<html>
    ...
    <body>
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-12" style="min-height: 600px; background-image: url(../images/emile-perron-xrVDYZRGdw4-unsplash.jpg);background-attachment: fixed; background-size: cover">
                    <h2 style="text-align: center;margin-top: 15px;margin-bottom: 20px; color: orangered">Enquiry Management</h2>
