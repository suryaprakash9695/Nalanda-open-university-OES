...
<html>
    ...
    <body>
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-12" style="min-height: 600px; background-image: url(../images/computerbg.jpg);background-repeat: no-repeat;background-size: cover;width: 100%;background-attachment:fixed">
                    <h2 style="color: maroon;margin-top: 15px; text-align: center;">News Management</h2>
                    <form class="form-group" method="post" action="admincontroller.jsp">
                        <input type="hidden" name="page" value="news"/>
                        <table style="margin:auto;width: 100%">
                            <tr>
                                <td>
                                    <textarea name="newstext" class="form-control" placeholder="Enter News" style="margin-top: 20px;margin-left: 160px;"></textarea>
                                    
                                </td>
                           
                           
                                <td>
                                    <button type="submit" class="btn btn-primary mt-3" style="margin-left:15px;">Add News</button>
                                </td>
                            </tr>
                        </table>
                    </form>
