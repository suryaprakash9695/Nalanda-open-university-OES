...
<html>
    ...
    <body>
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-12" style="min-height: 600px; background-image: url(../images/bluebackground.jpg);background-attachment: fixed;">
                    <h1 style="text-align: center;color:white;margin-top: 20px;margin-bottom: 20px;">View Questions</h1>
