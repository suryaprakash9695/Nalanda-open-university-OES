...
<html>
    ...
    <body>
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-12" style="min-height: 600px; background-image: url(../images/coursebg.jpg); background-repeat: no-repeat; background-size:cover;background-attachment: fixed;">
                    <h2 style="color: maroon; text-align: center;margin-top: 20px;margin-bottom: 20px;">Course Management</h2>
                    
                    <form class="form-group" method="post" action="admincontroller.jsp">
                        <input type="hidden" name="page" value="course"/>
                        <table style="width: 80%; margin: auto;border-radius: 10px;" >
                                <td>
                                    <input type="text" name="coursename" class="form-control" placeholder="Enter Course" required style="border-radius: 10px ;height:39px;margin-left:190px;width: 87%;"/>
                                </td>
                                <td>
                                    <button type="text" class="btn btn-success" style="margin-left:90px;">Submit</button>
                                </td>
                        </table>
                    </form>
                    <table class="table table-bordered" style="margin: auto;width: 70%;margin-top: 40px;">
                        <tr>
                        <th>Id</th>
                        <th>Course Name</th>
                        <th>Delete</th>
