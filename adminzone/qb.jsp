...
<html>
    ...
    <body>
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-12" style="min-height: 600px; background-image: url(../images/pencil.jpg); background-repeat: no-repeat;background-size: cover;background-attachment: fixed;">
                    <h2 style="text-align: center;color: white;margin-top: 20px;margin-bottom: 20px;">Question Bank Management</h2>
